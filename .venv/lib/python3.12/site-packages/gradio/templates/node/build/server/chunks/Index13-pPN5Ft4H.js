...
import { B as Block, S as Static, e as BlockLabel, O as Code$2, g as Empty, i as IconButton, H as Copy$1, D as Download$1, h as IconButtonWrapper } from './2-BK2b1QLK.js';
...
const lang_map = {
  python: () => import('./index27-BuflMQEp.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index28-C3J1PgOr.js'),
      import('./frontmatter-wUeqhXVI.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index32-CIbKwEJb.js').then((m) => m.json()),
  html: () => import('./index29-CeVHiC4o.js').then((m) => m.html()),
  css: () => import('./index30-B-hX-fg1.js').then((m) => m.css()),
  javascript: () => import('./index31-Dc146fqb.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index31-Dc146fqb.js').then(
...
//# sourceMappingURL=Index13-pPN5Ft4H.js.map
